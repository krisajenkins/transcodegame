...
handleUse object otherObject model =
    case ( object, otherObject ) of
        ...
        ( Parcel, WheelbarrowFixed ) ->
            ...
            in
                Just
                    ( { model | world = Dict.insert ( 7, 7 ) Path model.world }
...
pickUpFail object =
    case object of
        ...
        Fridge ->
            "I'd love to bring a fridge full of food with me, but that's not really possible."

        FridgeEmpty ->
            "There's not even any food in this.  I can't be bothered to take it with me."

        Paperwork ->
            "That must weigh a tonne!  Besides, I need to fill the forms out first..."

        PaperworkDone ->
            "I should package this ready to send before I try to move this."

        Package ->
            "I should put stamps on this first."

        Postbox ->
            "I could try, but then how would I send the forms?"

        Shed ->
            "It's a shed.  That won't fit in my pocket."

        Still ->
            "The still remains very still no matter how much I try to move it."

        WheelbarrowBroken ->
            "It's missing a wheel; I can't move that."
