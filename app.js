...
Elm.Types.make = function (_elm) {
   ...
   var removeItems = F2(function (items,model) {
      ...
      {player: _U.update(player,
      {inventory: A2($List.filter,function (_p0) {    return $Basics.not(A3($Basics.flip,$List.member,items,_p0));},model.player.inventory)})});
   });
   var addItems = F2(function (items,model) {
      var player = model.player;
      return _U.update(model,{player: _U.update(player,{inventory: A2($Basics._op["++"],items,model.player.inventory)})});
   });
   var combineItems = F4(function (obj1,obj2,result,model) {    return A2(addItems,_U.list([result]),A2(removeItems,_U.list([obj1,obj2]),model));});
   var canPickUp = function (object) {
      var _p1 = object;
      switch (_p1.ctor)
      {case "BlackBiro": return true;
         ...
         case "Parcel": return false;
         case "Postbox": return false;
         case "PotatoSackEmpty": return true;
         case "PotatoSackFull": return true;
   ...
   var movesFrom = function (_p2) {
      var _p3 = _p2;
      var _p5 = _p3._1;
      var _p4 = _p3._0;
      return $Set.fromList(_U.list([{ctor: "_Tuple2",_0: _p4 - 1,_1: _p5}
   ...
   var estimatedDistance = F2(function (_p7,_p6) {
      var _p8 = _p7;
      var _p9 = _p6;
      var dy = $Basics.toFloat($Basics.abs(_p8._1 - _p9._1));
      var dx = $Basics.toFloat($Basics.abs(_p8._0 - _p9._0));
      return $Basics.abs($Basics.sqrt(2) * A2($Basics.min,dx,dy) - $Basics.abs(dy - dx));
   });
   ...
   var validMovesFrom = F2(function (world,position) {
      return A2($Set.filter,function (_p11) {    return canStandOn(A2(objectAt,world,_p11));},movesFrom(position));
   });
   ...
   var Player = F2(function (a,b) {    return {position: a,inventory: b};});
   var PlayerCommand = function (a) {    return {ctor: "PlayerCommand",_0: a};};
   var Tick = function (a) {    return {ctor: "Tick",_0: a};};
   var PartialCommand = function (a) {    return {ctor: "PartialCommand",_0: a};};
   var InteractAt = F2(function (a,b) {    return {ctor: "InteractAt",_0: a,_1: b};});
   var Interact = function (a) {    return {ctor: "Interact",_0: a};};
   var Use = F2(function (a,b) {    return {ctor: "Use",_0: a,_1: b};});
   var Examine = function (a) {    return {ctor: "Examine",_0: a};};
   var PickUp = F2(function (a,b) {    return {ctor: "PickUp",_0: a,_1: b};});
   var WalkTo = function (a) {    return {ctor: "WalkTo",_0: a};};
   var PartialUseOne = function (a) {    return {ctor: "PartialUseOne",_0: a};};
   var PartialUse = {ctor: "PartialUse"};
   var PartialExamine = {ctor: "PartialExamine"};
   var PartialPickUp = {ctor: "PartialPickUp"};
   var Thing = function (a) {    return {ctor: "Thing",_0: a};};
   var Path = {ctor: "Path"};
   var Block = {ctor: "Block"};
   var ThePlayer = {ctor: "ThePlayer"};
   var WheelbarrowFull = {ctor: "WheelbarrowFull"};
   var WheelbarrowFixed = {ctor: "WheelbarrowFixed"};
   var WheelbarrowBroken = {ctor: "WheelbarrowBroken"};
   var UselessVaseFull = {ctor: "UselessVaseFull"};
   var UselessVaseEmpty = {ctor: "UselessVaseEmpty"};
   var Still = {ctor: "Still"};
   var Stamps = {ctor: "Stamps"};
   var Shed = {ctor: "Shed"};
   var Rag = {ctor: "Rag"};
   var PotatoSackFull = {ctor: "PotatoSackFull"};
   var PotatoSackEmpty = {ctor: "PotatoSackEmpty"};
   var Postbox = {ctor: "Postbox"};
   var Parcel = {ctor: "Parcel"};
   var PaperworkDone = {ctor: "PaperworkDone"};
   var Paperwork = {ctor: "Paperwork"};
   var Package = {ctor: "Package"};
   var MolotovLit = {ctor: "MolotovLit"};
   var Molotov = {ctor: "Molotov"};
   var Lighter = {ctor: "Lighter"};
   var FridgeEmpty = {ctor: "FridgeEmpty"};
   var Fridge = {ctor: "Fridge"};
   var Cinzano = {ctor: "Cinzano"};
   var Chicken = {ctor: "Chicken"};
   var BlackBiro = {ctor: "BlackBiro"};
   return _elm.Types.values = {_op: _op
                              ,BlackBiro: BlackBiro
                              ,Chicken: Chicken
                              ,Cinzano: Cinzano
                              ,Fridge: Fridge
                              ,FridgeEmpty: FridgeEmpty
                              ,Lighter: Lighter
                              ,Molotov: Molotov
                              ,MolotovLit: MolotovLit
                              ,Package: Package
                              ,Paperwork: Paperwork
                              ,PaperworkDone: PaperworkDone
                              ,Parcel: Parcel
                              ,Postbox: Postbox
                              ,PotatoSackEmpty: PotatoSackEmpty
                              ,PotatoSackFull: PotatoSackFull
                              ,Rag: Rag
                              ,Shed: Shed
                              ,Stamps: Stamps
                              ,Still: Still
                              ,UselessVaseEmpty: UselessVaseEmpty
                              ,UselessVaseFull: UselessVaseFull
                              ,WheelbarrowBroken: WheelbarrowBroken
                              ,WheelbarrowFixed: WheelbarrowFixed
                              ,WheelbarrowFull: WheelbarrowFull
                              ,ThePlayer: ThePlayer
                              ,Block: Block
                              ,Path: Path
                              ,Thing: Thing
                              ,PartialPickUp: PartialPickUp
                              ,PartialExamine: PartialExamine
                              ,PartialUse: PartialUse
                              ,PartialUseOne: PartialUseOne
                              ,WalkTo: WalkTo
                              ,PickUp: PickUp
                              ,Examine: Examine
                              ,Use: Use
...
Elm.Narrative = Elm.Narrative || {};
Elm.Narrative.make = function (_elm) {
   "use strict";
   _elm.Narrative = _elm.Narrative || {};
   if (_elm.Narrative.values) return _elm.Narrative.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   var _op = {};
   var pickUpFail = function (object) {
      var _p0 = object;
      switch (_p0.ctor)
      {case "ThePlayer": return "That was a real pick-me-up!";
         case "Fridge": return "I\'d love to bring a fridge full of food with me, but that\'s not really possible.";
         case "FridgeEmpty": return "There\'s not even any food in this.  I can\'t be bothered to take it with me.";
         case "Paperwork": return "That must weigh a tonne!  Besides, I need to fill the forms out first...";
         case "PaperworkDone": return "I should package this ready to send before I try to move this.";
         case "Package": return "I should put stamps on this first.";
         case "Postbox": return "I could try, but then how would I send the forms?";
         case "Shed": return "It\'s a shed.  That won\'t fit in my pocket.";
         case "Still": return "The still remains very still no matter how much I try to move it.";
         case "WheelbarrowBroken": return "It\'s missing a wheel; I can\'t move that.";
         default: return "I can\'t pick that up.";}
   };
   var examine = function (obj) {
      ...
      {case "BlackBiro": return "It\'s a biro. It writes in black ink. This looks perfect for filling in official documents.";
         ...
         case "MolotovLit": return "Might wanna throw this in the next few minutes. Just an idea. Maybe at something that will burn.";
         case "Package":
         ...
         case "Parcel": return "A beautifully wrapped, but slightly enormous, stamped and addressed parcel, ready for posting.";
         case "Postbox":
         ...
         case "PotatoSackEmpty": return "An empty potato sack. Perfect for filling with heavy things that need to stay together.";
         case "PotatoSackFull": return "Boil \'em, mash \'em, stick \'em in a stew.";
         case "Rag": return "Upon closer examination, you realise this rag used to be a pair of underwear. Whose underwear? Who knows.";
         case "Shed":
         ...
         case "Stamps": return "This looks like just about enough to send a really big parcel. You may die of dehydration whilst sticking them down though.";
         case "Still": return "This looks perfect for making potato moonshine.";
         case "UselessVaseEmpty": return "This vase is useless. Absolutely useless. Why are you still looking at it?";
         ...
         case "WheelbarrowBroken": return "This wheelbarrow doesn\'t have a working wheel. Might as well just call it a barrow.";
         case "WheelbarrowFixed": return "This looks like you could use it to transport something heavy.";
         case "WheelbarrowFull": return "Your precious paperwork, all packaged and ready to roll. Literally.";
   ...
   var nameOf = function (obj) {
      ...
      {case "BlackBiro": return "Black Biro";
         ...
         case "FridgeEmpty": return "Empty Fridge";
         case "Lighter": return "Lighter";
         case "Molotov": return "Molotov Cocktail";
         case "MolotovLit": return "Lit Molotov Cocktail";
         case "Package": return "Package";
         case "Paperwork": return "Paperwork";
         case "PaperworkDone": return "Completed Paperwork";
         case "Parcel": return "Parcel";
         case "Postbox": return "Postbox";
         case "PotatoSackEmpty": return "Empty Potato Sack";
         case "PotatoSackFull": return "Full Potato Sack";
         case "Rag": return "Rag";
         case "Shed": return "Shed";
         case "Stamps": return "Stamps";
         case "Still": return "Still";
         case "UselessVaseEmpty": return "Useless Empty Vase";
         case "UselessVaseFull": return "Useless Vase";
         case "WheelbarrowBroken": return "Broken Wheelbarrow";
         case "WheelbarrowFixed": return "Wheelbarrow";
         case "WheelbarrowFull": return "Loaded Wheelbarrow";
   ...
   var handleCommand = F2(function (command,model) {
      handleCommand: while (true) {
         var _p3 = command;
         switch (_p3.ctor)
         {case "WalkTo": var _p5 = _p3._0;
              if (!_U.eq(_p5,model.player.position)) if ($Types.canStandOn(A2($Types.objectAt,model.world,_p5))) return {ctor: "_Tuple2"
                                                                                                                        ,_0: _U.update(model,
                                                                                                                        {destination: $Maybe.Just(_p5)
                                                                                                                        ,partialCommand: $Maybe.Nothing})
                                                                                                                        ,_1: $Maybe.Just("Chaaaaarrrrrrge!")};
                 else {
                       var neighbours = A2($Types.validMovesFrom,model.world,_p5);
                       var _p4 = $List.head($Set.toList(neighbours));
                       if (_p4.ctor === "Nothing") {
                             return {ctor: "_Tuple2",_0: model,_1: $Maybe.Just("Hmmm...that looks like that would hurt.")};
                          } else {
                             var _v5 = $Types.WalkTo(_p4._0),_v6 = model;
                             command = _v5;
                             model = _v6;
                             continue handleCommand;
                          }
                    } else return {ctor: "_Tuple2",_0: model,_1: $Maybe.Just("I\'m already there.")};
            case "PartialCommand": var _p7 = _p3._0;
              return {ctor: "_Tuple2"
                     ,_0: _U.update(model,{partialCommand: $Maybe.Just(_p7)})
            ...
            case "PickUp": var _p8 = _p3._1;
              if ($Types.canPickUp(_p8)) {
                    var player = model.player;
                    var newModel = _U.update(model,
                    {world: A3($Dict.insert,_p3._0,$Types.Path,model.world),player: _U.update(player,{inventory: A2($List._op["::"],_p8,player.inventory)})});
                    return {ctor: "_Tuple2",_0: newModel,_1: $Maybe.Just(A2($Basics._op["++"],"I\'ve got: ",nameOf(_p8)))};
                 } else return {ctor: "_Tuple2",_0: model,_1: $Maybe.Just(pickUpFail(_p8))};
            case "Interact": switch (_p3._0.ctor)
              {case "Path": return {ctor: "_Tuple2",_0: model,_1: $Maybe.Nothing};
                 case "Block": return {ctor: "_Tuple2",_0: model,_1: $Maybe.Nothing};
                 default: var _p10 = _p3._0._0;
                   ...
                   if (_p9.ctor === "Just") {
                         ...
                         {case "PartialPickUp": return {ctor: "_Tuple2"
                            ...
                            case "PartialUse": return {ctor: "_Tuple2"
                                                      ,_0: _U.update(model,{partialCommand: $Maybe.Just($Types.PartialUseOne(_p10))})
                                                      ,_1: $Maybe.Just("What shall I use it with?")};
                            case "PartialUseOne": var _v9 = A2($Types.Use,_p10,_p9._0._0),_v10 = _U.update(model,{partialCommand: $Maybe.Nothing});
                              command = _v9;
                              model = _v10;
                              continue handleCommand;
                            default: var _v11 = $Types.Examine(_p10),_v12 = _U.update(model,{partialCommand: $Maybe.Nothing});
                              command = _v11;
                              model = _v12;
                              continue handleCommand;}
                      } else {
                         var _v13 = $Types.Examine(_p10),_v14 = model;
                         command = _v13;
                         model = _v14;
                         continue handleCommand;
                      }}
            case "Use": var _p12 = _p3._1;
              var _p11 = _p3._0;
              return A2($Maybe.withDefault,
              {ctor: "_Tuple2",_0: model,_1: $Maybe.Just("It\'s not going to work.")},
              $Maybe.oneOf(_U.list([A3(handleUse,_p11,_p12,model),A3(handleUse,_p12,_p11,model)])));
            case "InteractAt": switch (_p3._1.ctor)
              {case "Thing": var _p15 = _p3._0;
                   var _p14 = _p3._1._0;
                   var _p13 = model.partialCommand;
                   if (_p13.ctor === "Just" && _p13._0.ctor === "PartialPickUp") {
                         var _v16 = $Types.WalkTo(_p15),
                         _v17 = _U.update(model,{partialCommand: $Maybe.Nothing,queuedCommand: $Maybe.Just(A2($Types.PickUp,_p15,_p14))});
                         command = _v16;
                         model = _v17;
                         continue handleCommand;
                      } else {
                         var _v18 = $Types.Interact($Types.Thing(_p14)),_v19 = model;
                         command = _v18;
                         model = _v19;
                         continue handleCommand;
                      }
                 case "Block": var _p16 = model.partialCommand;
                   _v20_2: do {
                      if (_p16.ctor === "Just") {
                            switch (_p16._0.ctor)
                            {case "PartialPickUp": return {ctor: "_Tuple2"
                               ...
                               case "PartialExamine": return {ctor: "_Tuple2"
                                                             ,_0: _U.update(model,{partialCommand: $Maybe.Nothing})
                                                             ,_1: $Maybe.Just("It\'s a wall.")};
                               default: break _v20_2;}
                         } else {
                            break _v20_2;
                         }
                   } while (false);
                   var _v21 = $Types.WalkTo(_p3._0),_v22 = model;
                   command = _v21;
                   model = _v22;
                   continue handleCommand;
                 default: var _p17 = model.partialCommand;
                   _v23_2: do {
                      if (_p17.ctor === "Just") {
                            switch (_p17._0.ctor)
                            {case "PartialPickUp": return {ctor: "_Tuple2"
                               ...
                               case "PartialExamine": return {ctor: "_Tuple2"
                                                             ,_0: _U.update(model,{partialCommand: $Maybe.Nothing})
                                                             ,_1: $Maybe.Just("It\'s the floor.")};
                               default: break _v23_2;}
                         } else {
                            break _v23_2;
                         }
                   } while (false);
                   var _v24 = $Types.WalkTo(_p3._0),_v25 = model;
                   command = _v24;
                   model = _v25;
                   continue handleCommand;}
            default: switch (_p3._0.ctor)
              {case "UselessVaseFull": return {ctor: "_Tuple2"
                                              ,_0: A2($Types.addItems,
                                              _U.list([$Types.UselessVaseEmpty,$Types.Stamps]),
                                              A2($Types.removeItems,_U.list([$Types.UselessVaseFull]),model))
                                              ,_1: $Maybe.Just(examine($Types.UselessVaseFull))};
                 case "Fridge": var newInventory = A2($Types.addItems,_U.list([$Types.BlackBiro,$Types.UselessVaseFull]),model);
                   return {ctor: "_Tuple2"
                 ...
                 default: return {ctor: "_Tuple2",_0: model,_1: $Maybe.Just(examine(_p3._0))};}}
      }
   });
      ...
      _v26_14: do {
         if (_p18.ctor === "_Tuple2") {
               ...
               {case "ThePlayer": if (_p18._1.ctor === "ThePlayer") {
                  ...
                  case "Rag": if (_p18._1.ctor === "Cinzano") {
                          return $Maybe.Just({ctor: "_Tuple2"
                                             ,_0: A4($Types.combineItems,$Types.Rag,$Types.Cinzano,$Types.Molotov,model)
                  ...
                  case "Lighter": var _p19 = _p18._1;
                    ...
                    {case "Shed": return $Maybe.Just({ctor: "_Tuple2"
                       ...
                       case "Molotov": return $Maybe.Just({ctor: "_Tuple2"
                                                          ,_0: A4($Types.combineItems,$Types.Lighter,$Types.Molotov,$Types.MolotovLit,model)
                                                          ,_1: $Maybe.Just("Now it looks even more dangerous.")});
                       case "PotatoSackFull": return $Maybe.Just({ctor: "_Tuple2"
                                                                 ,_0: model
                                                                 ,_1: $Maybe.Just("You might be able to make roast potatoes this way, but it\'ll take a really long time.")});
                       default: return $Maybe.Nothing;}
                  case "MolotovLit": if (_p18._1.ctor === "Shed") {
                          var newInv = A2($Types.removeItems,_U.list([$Types.MolotovLit]),model);
                          var newModel = _U.update(newInv,
                          {world: A3($Dict.insert,{ctor: "_Tuple2",_0: 16,_1: 5},$Types.Thing($Types.WheelbarrowBroken),model.world)});
                          return $Maybe.Just({ctor: "_Tuple2"
                                             ,_0: newModel
                  ...
                  case "WheelbarrowBroken": if (_p18._1.ctor === "Chicken") {
                          return $Maybe.Just(A2(handleCommand,
                          A2($Types.PickUp,{ctor: "_Tuple2",_0: 16,_1: 5},$Types.WheelbarrowFixed),
                          A2($Types.removeItems,_U.list([$Types.Chicken]),model)));
                       } else {
                          break _v26_14;
                       }
                  case "Still": if (_p18._1.ctor === "PotatoSackFull") {
                          return $Maybe.Just({ctor: "_Tuple2"
                                             ,_0: A2($Types.addItems,
                                             _U.list([$Types.PotatoSackEmpty]),
                                             A2($Types.removeItems,_U.list([$Types.PotatoSackFull]),model))
                                             ,_1: $Maybe.Just("You empty the potatoes into the still and find yourself with an empty potato sack.")});
                       } else {
                          break _v26_14;
                       }
                  case "PotatoSackEmpty": if (_p18._1.ctor === "PaperworkDone") {
                          return $Maybe.Just({ctor: "_Tuple2"
                                             ,_0: A2($Types.removeItems,
                                             _U.list([$Types.PotatoSackEmpty]),
                  ...
                  case "Stamps": if (_p18._1.ctor === "Package") {
                          return $Maybe.Just({ctor: "_Tuple2"
                                             ,_0: A2($Types.removeItems,
                  ...
                  case "Parcel": if (_p18._1.ctor === "WheelbarrowFixed") {
                          var _p20 = A2(handleCommand,A2($Types.PickUp,{ctor: "_Tuple2",_0: 7,_1: 7},$Types.WheelbarrowFull),model);
                          var newModel = _p20._0;
                          return $Maybe.Just({ctor: "_Tuple2"
                                             ,_0: A2($Types.removeItems,
                                             _U.list([$Types.WheelbarrowFixed]),
                                             A2($Types.addItems,
                                             _U.list([$Types.WheelbarrowFull]),
                                             _U.update(model,{world: A3($Dict.insert,{ctor: "_Tuple2",_0: 7,_1: 7},$Types.Path,model.world)})))
                  ...
                  case "WheelbarrowFull": if (_p18._1.ctor === "Postbox") {
                          return $Maybe.Just({ctor: "_Tuple2"
                                             ,_0: A2($Types.addItems,
                                             _U.list([$Types.WheelbarrowFixed]),
                                             A2($Types.removeItems,_U.list([$Types.WheelbarrowFull]),model))
   ...
   return _elm.Narrative.values = {_op: _op,handleCommand: handleCommand,nameOf: nameOf,examine: examine,handleUse: handleUse,pickUpFail: pickUpFail};
};
Elm.Astar = Elm.Astar || {};
Elm.Astar.make = function (_elm) {
   ...
   var reconstructPath = F2(function (cameFrom,goal) {
      var _p0 = A2($Dict.get,goal,cameFrom);
      if (_p0.ctor === "Nothing") {
            return $Array.empty;
         } else {
            return A2($Array.push,goal,A2(reconstructPath,cameFrom,_p0._0));
         }
   });
   var updateCost = F3(function (current,neighbour,model) {
      var newCameFrom = A3($Dict.insert,neighbour,current,model.cameFrom);
      var distanceTo = $Basics.toFloat($Array.length(A2(reconstructPath,newCameFrom,neighbour)));
      var newModel = _U.update(model,{costs: A3($Dict.insert,neighbour,distanceTo,model.costs),cameFrom: newCameFrom});
      var _p1 = A2($Dict.get,neighbour,model.costs);
      if (_p1.ctor === "Nothing") {
            return newModel;
         } else {
            return _U.cmp(distanceTo,_p1._0) < 0 ? newModel : model;
         }
   });
   var cheapestOpen = F2(function (costFn,model) {
      ...
      A2($List.filterMap,
      function (position) {
         var _p2 = A2($Dict.get,position,model.costs);
         if (_p2.ctor === "Nothing") {
               return $Maybe.Nothing;
            } else {
               return $Maybe.Just({ctor: "_Tuple2",_0: position,_1: _p2._0 + costFn(position)});
            }
      },
      $Set.toList(model.openSet)))));
   });
   var astar = F4(function (costFn,moveFn,goal,model) {
      astar: while (true) {
         var _p3 = A2(cheapestOpen,costFn(goal),model);
         if (_p3.ctor === "Nothing") {
               return $Maybe.Nothing;
            } else {
               var _p4 = _p3._0;
               if (_U.eq(_p4,goal)) return $Maybe.Just(A2(reconstructPath,model.cameFrom,goal)); else {
                     var neighbours = moveFn(_p4);
                     var modelPopped = _U.update(model,{openSet: A2($Set.remove,_p4,model.openSet),evaluated: A2($Set.insert,_p4,model.evaluated)});
                     ...
                     var modelWithCosts = A3($Set.foldl,updateCost(_p4),modelWithNeighbours,newNeighbours);
                     var _v4 = costFn,_v5 = moveFn,_v6 = goal,_v7 = modelWithCosts;
                     costFn = _v4;
                     moveFn = _v5;
                     goal = _v6;
                     model = _v7;
   ...
   var findPath = F4(function (costFn,moveFn,start,end) {    return A4(astar,costFn,moveFn,end,initialModel(start));});
   var Model = F4(function (a,b,c,d) {    return {evaluated: a,openSet: b,costs: c,cameFrom: d};});
   return _elm.Astar.values = {_op: _op,findPath: findPath};
};
Elm.State = Elm.State || {};
Elm.State.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Narrative = Elm.Narrative.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Time = Elm.Time.make(_elm),
   $Types = Elm.Types.make(_elm);
   ...
   var initialWorld = function () {
      var _p2 = {ctor: "_Tuple2",_0: 17,_1: 10};
      var maxX = _p2._0;
      var maxY = _p2._1;
      ...
      return $Dict.fromList($List.concat(_U.list([A2($List.concatMap,
                                                 ...
                                                 ,A2(verticalWall,5,_U.range(1,4))
                                                 ,A2(horizontalWall,_U.range(5,8),4)
                                                 ,A2(verticalWall,12,_U.range(1,3))
                                                 ,A2(horizontalWall,_U.range(5,8),6)
                                                 ...
                                                 ,_U.list([{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: 11,_1: 2},_1: $Types.Thing($Types.Fridge)}])
                                                 ,_U.list([{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: 14,_1: 2},_1: $Types.Thing($Types.Lighter)}])
                                                 ,_U.list([{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: 15,_1: 2},_1: $Types.Thing($Types.Still)}])
                                                 ,_U.list([{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: 6,_1: 9},_1: $Types.Thing($Types.Rag)}])
                                                 ,_U.list([{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: 7,_1: 7},_1: $Types.Thing($Types.Paperwork)}])
                                                 ,_U.list([{ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: 11,_1: 9},_1: $Types.Thing($Types.Cinzano)}])])));
   }();
   var initialModel = {world: initialWorld
                      ,dialogue: $Maybe.Just("Well, I guess I\'d better look around...")
                      ,partialCommand: $Maybe.Nothing
                      ,player: {position: {ctor: "_Tuple2",_0: 1,_1: 1},inventory: _U.list([])}
                      ,destination: $Maybe.Nothing
                      ,queuedCommand: $Maybe.Nothing
                      ,timeSinceLastMove: $Maybe.Nothing};
   var stepTime = 100 * $Time.millisecond;
   var handleWalk = F2(function (time,model) {
      var _p4 = model.destination;
      if (_p4.ctor === "Nothing") {
            ...
            if (_U.cmp(previousTime + stepTime,time) > 0) return {ctor: "_Tuple2",_0: model,_1: $Maybe.Nothing}; else {
                  var _p5 = A4($Astar.findPath,$Types.estimatedDistance,$Types.validMovesFrom(model.world),model.player.position,_p4._0);
                  if (_p5.ctor === "Nothing") {
                        return {ctor: "_Tuple2"
                               ,_0: _U.update(model,{destination: $Maybe.Nothing,timeSinceLastMove: $Maybe.Nothing})
                               ,_1: $Maybe.Just("Hmm...I can\'t find a way there.")};
                     } else {
                        var _p6 = A2($Array.get,0,_p5._0);
                        if (_p6.ctor === "Nothing") {
                              var newModel = _U.update(model,{destination: $Maybe.Nothing,timeSinceLastMove: $Maybe.Nothing,queuedCommand: $Maybe.Nothing});
                              var _p7 = model.queuedCommand;
                              if (_p7.ctor === "Nothing") {
                                    return {ctor: "_Tuple2",_0: newModel,_1: $Maybe.Just("J\'arrive!")};
                                 } else {
                                    return A2($Narrative.handleCommand,_p7._0,_U.update(newModel,{queuedCommand: $Maybe.Nothing}));
                                 }
                           } else {
                              var player = model.player;
                              return {ctor: "_Tuple2"
                                     ,_0: _U.update(model,{player: _U.update(player,{position: _p6._0}),timeSinceLastMove: $Maybe.Just(time)})
                                     ,_1: $Maybe.Nothing};
                           }
                     }
               }
   ...
   var updateWithDialogue = F2(function (action,model) {
      var _p8 = action;
      if (_p8.ctor === "PlayerCommand") {
            return A2($Narrative.handleCommand,_p8._0,model);
         } else {
            return A2(handleWalk,_p8._0,model);
         }
   });
   var update = F2(function (action,model) {
      var _p9 = A2(updateWithDialogue,action,model);
      var newModel = _p9._0;
      var newDialogue = _p9._1;
...
Elm.View.Svg.make = function (_elm) {
   ...
   var _op = {};
   var tileSize = 45;
   var patternDefs = function (objectName) {
      return A2($Svg.defs,
      _U.list([]),
      _U.list([A2($Svg.pattern,
      _U.list([$Svg$Attributes.id(objectName)
      ...
      _U.list([A2($Svg.image,
      _U.list([$Svg$Attributes.xlinkHref(A2($Basics._op["++"],"images/",A2($Basics._op["++"],objectName,".png")))
              ,$Svg$Attributes.x($Common$View.px(0))
              ,$Svg$Attributes.y($Common$View.px(0))
              ,$Svg$Attributes.width($Common$View.px(tileSize))
              ,$Svg$Attributes.height($Common$View.px(tileSize))]),
      _U.list([]))]))]));
   };
   var tile = F3(function (address,position,cell) {
      var _p0 = function () {
         var _p1 = cell;
         switch (_p1.ctor)
         {case "Path": return {ctor: "_Tuple3"
                              ,_0: A2($Svg.defs,_U.list([]),_U.list([]))
                              ,_1: _U.list([$Svg$Attributes.stroke("grey"),$Svg$Attributes.fill("#fdfdfd")])
                              ,_2: $Maybe.Just(A2($Types.InteractAt,position,$Types.Path))};
            case "Block": return {ctor: "_Tuple3"
                                 ,_0: A2($Svg.defs,_U.list([]),_U.list([]))
                                 ,_1: _U.list([$Svg$Attributes.stroke("#0466da"),$Svg$Attributes.fill("#04c9da")])
                                 ,_2: $Maybe.Just(A2($Types.InteractAt,position,$Types.Block))};
            default: if (_p1._0.ctor === "ThePlayer") {
                    return {ctor: "_Tuple3"
                           ,_0: patternDefs($Basics.toString($Types.ThePlayer))
                           ,_1: _U.list([$Svg$Attributes.stroke("#8504da"),$Svg$Attributes.fill("url(#ThePlayer)")])
                           ,_2: $Maybe.Just(A2($Types.InteractAt,position,$Types.Thing($Types.ThePlayer)))};
                 } else {
                    var _p2 = _p1._0;
                    return {ctor: "_Tuple3"
                           ,_0: patternDefs($Basics.toString(_p2))
                           ,_1: _U.list([$Svg$Attributes.stroke("black")
                                        ,$Svg$Attributes.fill(A2($Basics._op["++"],"url(#",A2($Basics._op["++"],$Basics.toString(_p2),")")))])
                           ,_2: $Maybe.Just(A2($Types.InteractAt,position,$Types.Thing(_p2)))};
                 }}
      }();
      var preamble = _p0._0;
      var colours = _p0._1;
      ...
      _U.list([preamble
              ...
              function () {
                 ...
                 if (_p3.ctor === "Nothing") {
                       ...
                       return _U.list([$Svg$Events.onClick(A2($Signal.message,address,$Types.PlayerCommand(_p3._0)))]);
                    }
              }())),
              _U.list([]))]));
   });
   var root = F2(function (address,model) {
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width($Common$View.px(18 * tileSize)),$Svg$Attributes.height($Common$View.px(11 * tileSize))]),
      _U.list([A2($Svg.g,_U.list([]),A2($List.map,$Basics.uncurry(tile(address)),$Dict.toList(model.world)))
              ,A3(tile,address,model.player.position,$Types.Thing($Types.ThePlayer))]));
   });
   return _elm.View.Svg.values = {_op: _op,root: root,tileSize: tileSize};
};
Elm.View = Elm.View || {};
Elm.View.make = function (_elm) {
   ...
   var _op = {};
   var commandButton = F2(function (address,_p0) {
      var _p1 = _p0;
      return A2($Html.button,
      _U.list([$Html$Attributes.$class("btn btn-lg btn-info"),A2($Html$Events.onClick,address,$Types.PlayerCommand(_p1._0))]),
      _U.list([$Html.text(_p1._1)]));
   });
   var partialCommandView = function (partialCommand) {
      return A2($Html.div,
      _U.list([]),
      _U.list([$Html.text(function () {
         ...
         if (_p2.ctor === "Nothing") {
               ...
               switch (_p2._0.ctor)
               {case "PartialPickUp": return "Pick up...";
                  case "PartialExamine": return "Examine...";
                  case "PartialUse": return "Use...";
                  default: return A2($Basics._op["++"],"Use ",A2($Basics._op["++"],$Narrative.nameOf(_p2._0._0)," with..."));}
            }
      }())]));
   };
   var inventoryObjectView = F2(function (address,object) {
      return A2($Html.button,
      _U.list([$Html$Attributes.$class("btn btn.info inventory-button")
   ...
   var inventoryView = F2(function (address,inventory) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h4,_U.list([]),_U.list([$Html.text("Inventory")]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("inventory")]),A2($List.map,inventoryObjectView(address),inventory))]));
   });
   var root = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("main-content")
              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: $Common$View.px(19 * $View$Svg.tileSize)}
                                              ,{ctor: "_Tuple2",_0: "height",_1: $Common$View.px(12 * $View$Svg.tileSize)}
                                              ,{ctor: "_Tuple2",_0: "margin",_1: "0 auto"}]))]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "perspective",_1: $Common$View.px(1000)}
                                                      ,{ctor: "_Tuple2",_0: "margin-top",_1: $Common$View.px(-50)}
                                                      ,{ctor: "_Tuple2",_0: "text-align",_1: "center"}]))]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "transform",_1: "rotate3d(1,0,0,35deg)"}
              ...
              ,A2($Html.p,_U.list([$Html$Attributes.$class("dialogue")]),_U.list([$Html.text(A2($Maybe.withDefault,"",model.dialogue))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("btn-group")]),
              A2($List.map,
              commandButton(address),
              _U.list([{ctor: "_Tuple2",_0: $Types.PartialCommand($Types.PartialPickUp),_1: "Pick up"}
                      ,{ctor: "_Tuple2",_0: $Types.PartialCommand($Types.PartialExamine),_1: "Examine"}
                      ,{ctor: "_Tuple2",_0: $Types.PartialCommand($Types.PartialUse),_1: "Use"}])))
              ,A2(inventoryView,address,model.player.inventory)
...
Elm.App.make = function (_elm) {
   ...
   var app = $StartApp.start({init: {ctor: "_Tuple2",_0: $State.initialModel,_1: $State.initialEffects}
                             ...
                             ,update: F2(function (action,oldModel) {
                                var newModel = A2($State.update,A2($Debug.log,"ACTION",action),oldModel);
